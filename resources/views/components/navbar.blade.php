...
<div class="bg-banner-top transition-all duration-300 z-[999]" id="topBanner">
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 ">
    <div class="flex items-center justify-between gap-4 py-2 text-sm">
      <!-- Location - Left -->
      <div>
        <a href="https://maps.app.goo.gl/7yy9CGeusdYc9hNG7" target="_blank" class="flex items-center gap-1.5 text-banner-text hover:text-banner-text-alt transition duration-300">
      ...
      <div class="flex items-center gap-4">
        <a href="https://wa.me/6281234567890" target="_blank" class="flex items-center gap-1.5 text-banner-text hover:text-banner-text-alt transition duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="mailto:info@grahaoffice.com" class="flex items-center gap-1.5 text-banner-text hover:text-banner-text-alt transition duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-16 items-center justify-between">
            ...
            <li class="relative" x-data="{ open: false }">
              ...
              <div
                ...
                <div class="py-1 bg-dropdown">
                  <a href="{{ url('/layanan/virtual-office') }}" class="block px-4 py-2 text-base text-primary-text hover:bg-beige hover:text-secondary-text-600 {{ request()->is('layanan/virtual-office') ? 'text-secondary-text-600 font-semibold bg-beige' : '' }}">
                    Virtual Office
                  </a>
                  <a href="{{ url('/layanan/private-office') }}" class="block px-4 py-2 text-base text-primary-text hover:bg-beige hover:text-secondary-text-600 {{ request()->is('layanan/private-office') ? 'text-secondary-text-600 font-semibold bg-beige' : '' }}">
                    Private Office
                  </a>
                  <a href="{{ url('/layanan/shared-office') }}" class="block px-4 py-2 text-base text-primary-text hover:bg-beige hover:text-secondary-text-600 {{ request()->is('layanan/shared-office') ? 'text-secondary-text-600 font-semibold bg-beige' : '' }}">
                    Shared Office
                  </a>
                  <a href="{{ url('/layanan/pembuatan-pt-cv') }}" class="block px-4 py-2 text-base text-primary-text hover:bg-beige hover:text-secondary-text-600 {{ request()->is('layanan/pembuatan-pt-cv') ? 'text-secondary-text-600 font-semibold bg-beige' : '' }}">
                    Pembuatan PT & CV
                  </a>
                  <a href="{{ url('/layanan/paket-hemat') }}" class="block px-4 py-2 text-base text-primary-text hover:bg-beige hover:text-secondary-text-600 {{ request()->is('layanan/paket-hemat') ? 'text-secondary-text-600 font-semibold bg-beige' : '' }}">
                    Paket Hemat
                  </a>
                </div>
              </div>
      ...
      <div class="block md:hidden" x-data="{ mobileMenuOpen: false }">
        <button
          class="rounded-lg bg-beige p-2 text-navy-light transition hover:text-secondary-text-600"
        ...
        <div
          ...
          <div class="p-4">
            <div class="flex items-center justify-between">
              <a href="{{ url('/beranda') }}" class="text-secondary-text-600">
                <span class="sr-only">Home</span>
              ...
              <button
                ...
                class="rounded-lg p-2 text-navy-light hover:text-secondary-text-600 focus:ring-2 focus:ring-blue-600">
            ...
            <nav class="mt-8">
              <ul class="space-y-4">
                <li>
                  <a
                    href="{{ url('/beranda') }}"
                    class="block text-base font-medium {{ request()->is('beranda') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                    Beranda
                  </a>
                </li>
                <li>
                  <div class="space-y-2">
                    <span class="block text-base font-medium text-primary-text-600">Layanan</span>
                    <ul class="ml-4 space-y-2">
                      <li>
                        <a
                          href="{{ url('/layanan#virtual-office') }}"
                          class="block text-sm {{ request()->is('layanan/virtual-office') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                          Virtual Office
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          class="block text-sm {{ request()->is('layanan/private-office') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                          Private Office
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          class="block text-sm {{ request()->is('layanan/shared-office') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                          Shared Office
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          class="block text-sm {{ request()->is('layanan/pembuatan-pt-cv') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                          Pembuatan PT & CV
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          class="block text-sm {{ request()->is('layanan/paket-hemat') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                          Paket Hemat
                        </a>
                      </li>
                    </ul>
                ...
                <li>
                  <a
                    href="{{ url('/galeri') }}"
                    class="block text-base font-medium {{ request()->is('galeri') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                    Galeri
                  </a>
                </li>
                <li>
                  <a
                    href="{{ url('/kontak') }}"
                    class="block text-base font-medium {{ request()->is('kontak') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                    Kontak
                  </a>
                </li>
                <li>
                  <a
                    href="{{ url('/job') }}"
                    class="block text-base font-medium {{ request()->is('job') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                    Job
                  </a>
                </li>
                <li>
                  <a
                    href="{{ url('/blog') }}"
                    class="block text-base font-medium {{ request()->is('blog') ? 'text-teal-600 font-bold' : 'text-primary-text-600 hover:text-primary-text-900' }}">
                    Blog
                  </a>
                </li>
              </ul>
