<div class="bg-primary-wcu rounded-xl p-6 hover:shadow-icon-wcu shadow-lg hover:scale-105 transition duration-300 group ring-icon-wcu ring-0 hover:ring-2">
