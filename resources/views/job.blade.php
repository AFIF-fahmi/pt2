...
@section('content')
<!-- Hero Section -->
<section class="relative bg-primary text-card py-32">
    ...
    <div class="relative container mx-auto px-8">
        ...
        <p class="text-xl text-light max-w-2xl">Bergabunglah dengan tim kami dan kembangkan karir Anda bersama perusahaan yang terus berkembang</p>
    </div>
</section>
...
<section class="py-20 bg-base">
    <div class="container mx-auto px-4">
        <div class="max-w-dvw mx-auto bg-card rounded-xl shadow-lg overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="p-8">
                    <!-- Company Introduction -->
                    <div class="mb-12">
                        <h2 class="text-2xl font-bold text-primary-heading mb-4">GRAHA OFFICE</h2>
                        <p class="text-secondary-heading mb-4">GRAHA OFFICE (PT Graha Pelita Nusantara Indonesia) adalah provider / penyedia kantor bersama yang telah berdiri lebih dari 10 tahun dalam menyediakan berbagai layanan terutama virtual office, coworking space, sewa ruang kantor, manajemen properti, jasa pengurusan legalitas dan pendirian perusahaan.</p>
                    </div>

                    <!-- Job Position -->
                    <div class="mb-12">
                        <h3 class="text-xl font-bold text-navy mb-4">CUSTOMER SERVICE & ADMIN</h3>

                        <!-- Job Description -->
                        <div class="mb-8">
                            <h4 class="font-semibold text-navy-light mb-3">Job Description:</h4>
                            <ul class="list-disc list-inside space-y-2 text-navy-light ml-4">
                        ...
                        <!-- Requirements -->
                        <div class="mb-8">
                            <h4 class="font-semibold text-navy-light mb-3">Requirements:</h4>
                            <ul class="list-disc list-inside space-y-2 text-navy-light ml-4">
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            <p class="text-navy-light">Untuk submit lamaran bisa melalui Google Form berikut:</p>
                            <a
                                href="https://docs.google.com/forms/d/e/1FAIpQLSeEb3egzFsWN6ifgZCmpujc4mlMwFMXGQRx2T8B-m9UH8CtyA/viewform"
                                id="applyButton"
                                target="_blank"
                                class="btn-primary inline-flex items-center px-8 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-button-primary focus:ring-offset-2">
                    ...
                    <!-- Company Info -->
                    <div class="border-t border-gray-light pt-8">
                        <div class="text-center">
                            <h4 class="font-bold text-navy mb-4">GRAHA OFFICE</h4>
                            <div class="space-y-2 text-navy-light">
