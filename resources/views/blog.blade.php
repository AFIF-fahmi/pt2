...
<section class="relative layout-primary py-32">
    ...
    <div class="relative container mx-auto px-8">
        ...
        <p class="text-xl text-light max-w-2xl">Temukan artikel menarik dan informasi terbaru seputar bisnis, teknologi, dan lifestyle</p>
    </div>
</section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="card-base overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-navy mb-3 blog-title">
                            <a href="#" class="hover:text-blue transition">5 Tips Meningkatkan Brand Awareness Bisnis</a>
                        </h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-navy-light">Dwi Putri</span>
                            </div>
                            <a href="#" class="text-blue hover:text-steel-blue font-semibold flex items-center group">
                ...
                <!-- Blog Post 2 -->
                <article class="blog-card bg-ivory rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                    <div class="relative">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-navy mb-3 blog-title">
                            <a href="#" class="hover:text-blue transition">5 Alasan Mengapa Pebisnis Harus Menggunakan Virtual Office</a>
                        </h3>
                        <p class="text-navy-light mb-4">
                ...
                <article class="blog-card bg-ivory rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-navy mb-3 blog-title">
                            <a href="#" class="hover:text-blue transition">Keep Happy! 5 Kunci Bahagia Bagi Anak Muda</a>
                        </h3>
                        <p class="text-navy-light mb-4">
