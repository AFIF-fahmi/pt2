...
<section class="py-8 bg-primary-bckg">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            <!-- Feature 1 -->
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    ...
                    <p class="text-2xl pt-3 align-middle font-bold text-secondary-text mb-5">Lokasi Strategis</p>
                </div>
            ...
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    <div class="bg-icon-wcu px-3 w-14 h-14 rounded-lg flex items-center justify-center mb-1 group-hover:scale-115 transition duration-300">
                        <svg class="w-8 h-8 text-primary-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <p class="text-2xl -translate-y-1 align-middle font-bold text-secondary-text">Pelayanan Profesional</p>
                </div>
            ...
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    ...
                    <p class="text-2xl pt-3 align-middle font-bold text-secondary-text mb-5">Proses Cepat</p>
                </div>
            ...
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    ...
                    <p class="text-2xl pt-3 align-middle font-bold text-secondary-text mb-5">Harga Bersaing</p>
                </div>
            ...
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    ...
                    <p class="text-2xl pt-3 align-middle font-bold text-secondary-text mb-5">Fasilitas Lengkap</p>
                </div>
            ...
            <div class="bg-primary-wcu rounded-xl p-6 hover:shadow-lg hover:scale-105 transition duration-300 group">
                <div class="flex justify-start gap-3">
                    ...
                    <p class="text-2xl pt-3 align-middle font-bold text-secondary-text mb-5">Keamanan Terjamin</p>
                </div>
